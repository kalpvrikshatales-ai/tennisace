...
async def wimbledon_draw(gender: str = "men"):
    ...
    for m in raw:
        ...
        by_round[rnd].append({
            ...
            "player1_country": m.get("event_first_player_country") or m.get("first_player_country"),
            "player2_country": m.get("event_second_player_country") or m.get("second_player_country"),
